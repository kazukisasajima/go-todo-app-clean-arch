...
type ServerInterface interface {
	...
	// Delete a user by ID
	// (DELETE /users/{id})
	DeleteUserById(c *gin.Context, id int)
	// Get a user by ID
	// (GET /users/{id})
	GetUserById(c *gin.Context, id int)
	// Get tasks for a specific user
	// (GET /users/{id}/tasks)
	GetTasksForUser(c *gin.Context, id int)
}
...
func (siw *ServerInterfaceWrapper) GetTasksForUser(c *gin.Context) {
	...
	siw.Handler.GetTasksForUser(c, id)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.DELETE(options.BaseURL+"/users/:id", wrapper.DeleteUserById)
	router.GET(options.BaseURL+"/users/:id", wrapper.GetUserById)
	router.GET(options.BaseURL+"/users/:id/tasks", wrapper.GetTasksForUser)
}
